...
namespace Object_Classes {
    ...
    public class Player {
        ...
        public void Play(Die d1, Die d2) {
            ...
            //Roll dice, sum of the two dice rolls is the steps player takes forward
            int Roll1 = d1.Roll();
            int Roll2 = d2.Roll();
            int MoveForward = Roll1 + Roll2;

            //update players position and location
            ...
            //determine outcome of landing on square
            location.LandOn(this);

            //check if player is at final square and if player still has power
